...
export function ThemeRow({ cluster, signalBreakdown, linkedCardCount, rank, docketId }: ThemeRowProps) {
    ...
    <>
      ...
      <div className="theme-row-metrics">
        ...
        <div className="theme-signal-bar" aria-label="Signal distribution">
          {signalBreakdown.high > 0 ? <div className="signal-seg signal-high" style={{ flex: signalBreakdown.high }} /> : null}
